  ...
  return (
    ...
    >
      <div className={cn(
        ...
        scrolled 
          ? "bg-black/40 backdrop-blur-xl border border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.5)]" 
        ...
        <div className="font-display uppercase tracking-widest text-primary text-xl font-bold hover:text-glow-green transition-colors cursor-pointer mix-blend-screen">
          JN / LABS
        </div>
        <div className="flex gap-8 font-sans text-nav lowercase text-secondary transition-colors duration-300">
